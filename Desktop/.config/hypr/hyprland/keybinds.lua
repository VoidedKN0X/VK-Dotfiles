...
hl.bind("SUPER + SHIFT + W", hl.dsp.exec_cmd("rofi -show wallpaper -modi \"wallpaper:~/.config/hypr/scripts/wallpaper-picker.sh\" -theme ~/.config/rofi/wallpaper-picker.rasi -show-icons"))
hl.bind("SUPER + SHIFT + H", hl.dsp.exec_cmd("cliphist list | rofi -dmenu -p \"Clipboard\" -theme ~/.config/rofi/clipboard.rasi | cliphist decode | wl-copy"))
